    ...
    <div className="font-sans bg-[#121212] text-gray-100 min-h-screen">
        ...
        <div className="max-w-6xl mx-auto px-6 py-16 md:py-24 relative z-10">
          <div className="relative">
            <h1 className="text-4xl md:text-6xl font-light text-gray-100 mb-4">
              Hi, I'm <span className="font-semibold text-purple-400">Kinshuk Jain</span>
            </h1>
            
            <p className="text-xl md:text-2xl text-gray-300 max-w-2xl mb-8">
              I build cost-effective, secure, and scalable cloud solutions, solving real-world problems that make a meaningful impact.
            </p>
        ...
        <div className="absolute top-0 right-0 h-full w-1/2 opacity-10">
          <div className="absolute top-0 right-0 w-full h-full">
            <svg width="100%" height="100%" viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg">
              ...
              <rect x="100" y="250" width="300" height="300" rx="20" fill="url(#grad1)" />
            </svg>
          </div>
        </div>
      </header>
        ...
        <section className="mb-16">
          ...
          <div className="bg-[#232323] rounded-lg shadow-md border border-gray-800 p-6 mb-6">
            <div className="flex flex-col md:flex-row md:justify-between md:items-center">
              <div>
                <h3 className="text-xl font-semibold text-gray-100">Bachelor of Technology, Electrical Engineering</h3>
                <p className="text-gray-300 mt-1">JSS Academy of Technical Education</p>
          ...
          <div className="bg-[#232323] rounded-lg shadow-md border border-gray-800 p-6">
            <div className="flex flex-col md:flex-row md:justify-between md:items-center">
              <div>
                <h3 className="text-xl font-semibold text-gray-100">Higher Secondary Education (XII)</h3>
        ...
        <section className="mb-16">
          ...
          <div className="bg-[#232323] bg-opacity-20 border-l-4 border-purple-500 p-6 rounded mb-8">
            <h3 className="text-xl font-semibold text-gray-100 flex items-center mb-3">
              <FaAws className="mr-2 text-purple-400" /> My AWS Certification Journey
            </h3>
            <p className="text-gray-300">
              ...
              <span className="font-medium text-purple-300"> strengthened my resolve </span>
          ...
          <div className="bg-[#232323] border border-gray-800 rounded-lg shadow-md mb-8 overflow-hidden">
            <div className="p-6">
              ...
              <div className="grid md:grid-cols-2 gap-6 mt-6">
                <div>
                  <h4 className="text-lg font-medium text-gray-100 mb-3">Key Features</h4>
                  <ul className="space-y-2 text-gray-300">
                    <li className="flex items-start">
                      <svg className="h-5 w-5 text-purple-400 mr-2 mt-0.5" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div>
                  <h4 className="text-lg font-medium text-gray-100 mb-3">Technical Details</h4>
                  <ul className="space-y-2 text-gray-300">
                    <li className="flex items-start">
                      <svg className="h-5 w-5 text-purple-400 mr-2 mt-0.5" viewBox="0 0 20 20" fill="currentColor">
                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
              ...
              <div className="mt-6 pt-6 border-t border-gray-800">
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="px-3 py-1 bg-black text-gray-200 text-xs rounded-full border border-gray-700">React 19</span>
                  <span className="px-3 py-1 bg-black text-gray-200 text-xs rounded-full border border-gray-700">TypeScript</span>
                  <span className="px-3 py-1 bg-black text-gray-200 text-xs rounded-full border border-gray-700">Tailwind CSS</span>
                  <span className="px-3 py-1 bg-black text-gray-200 text-xs rounded-full border border-gray-700">Framer Motion</span>
                  <span className="px-3 py-1 bg-black text-gray-200 text-xs rounded-full border border-gray-700">AWS Amplify</span>
                  <span className="px-3 py-1 bg-black text-gray-200 text-xs rounded-full border border-gray-700">Route 53</span>
                  <span className="px-3 py-1 bg-black text-gray-200 text-xs rounded-full border border-gray-700">Hostinger</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="p-6">
              ...
              <ul className="mt-4 space-y-2 text-gray-300">
                ...
                <li className="flex items-start">
                  ...
                  Published technical articles covering AWS, serverless architecture, and React development
                </li>
              </ul>
              ...
              <div className="mt-6 pt-6 border-t border-gray-800">
                <h4 className="text-sm font-medium text-gray-400 mb-3">Technologies Used:</h4>
                <div className="flex flex-wrap gap-2">
                  <span className="px-3 py-1 bg-black text-gray-200 text-xs rounded-full border border-gray-700">Hashnode</span>
                  <span className="px-3 py-1 bg-black text-gray-200 text-xs rounded-full border border-gray-700">Amazon Route 53</span>
                  <span className="px-3 py-1 bg-black text-gray-200 text-xs rounded-full border border-gray-700">Hostinger</span>
                  <span className="px-3 py-1 bg-black text-gray-200 text-xs rounded-full border border-gray-700">DNS Management</span>
                  <span className="px-3 py-1 bg-black text-gray-200 text-xs rounded-full border border-gray-700">Custom Domain</span>
                  <span className="px-3 py-1 bg-black text-gray-200 text-xs rounded-full border border-gray-700">CDN</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <footer className="bg-black border-t border-gray-800 py-8">
        <div className="max-w-6xl mx-auto px-6 text-center">
          <div className="h-1 w-24 bg-gradient-to-r from-purple-700 to-purple-400 mx-auto mb-6"></div>
          <p className="text-gray-300">
            Want to explore my learning journey? Check out the{" "}
            <span className="text-purple-400 font-medium">Resources</span> tab in the header!
          </p>
