                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-lg font-medium group-hover:text-white  underline text-white ">
                        {social.platform}
                      </span>
                      </div>
                    </div>
                  ...
                  <div className="flex flex-col sm:flex-row justify-between sm:items-start gap-4">
                    ...
                    {cert.url && (
                      <a
                        ...
                        className="flex-shrink-0 inline-flex items-center       text-black bg-white  gap-2 px-2 py-2  text-sm font-medium rounded-md w-max   transition-colors"
                      >
                        View Credential{" "}
                  ...
                  <div className="flex items-center gap-4 mt-6 pt-4 -t ">
                    {project.links.live && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center rounded-md bg-blue-700  text-white  p-1.5  gap-2 text-sm  transition-colors"
                      >
                        <FaGlobe /> Live Demo
                      </a>
                    )}
