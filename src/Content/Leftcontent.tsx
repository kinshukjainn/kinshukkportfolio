...
const LeftContent: React.FC<LeftContentProps> = ({ className = "" }) => {
  ...
  return (
    <motion.div
      ...
      className={`bg-gradient-to-br from-gray-900 via-gray-800 to-black border border-gray-800 rounded-3xl font-inter hover:shadow-lg p-4 md:p-6 w-full max-w-3xl mx-auto lg:mx-0 ${className}`}
    >
      {loading ? (
        ...
        <>
          ...
          {githubData ? (
            <div className="text-lg text-white">
              ...
              <a
                ...
                className="text-white bg-gradient-to-r from-purple-500 to-pink-500 w-max p-2 rounded-full text-sm flex items-center gap-1 mt-2 shadow-lg shadow-white transition-all duration-300 hover:shadow-white hover:scale-105"
              >
          ...
          <div className="mt-6 p-4 bg-gradient-to-r from-gray-800 to-black shadow-lg shadow-white transition-all duration-300 hover:shadow-white rounded-3xl border border-gray-600 ">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-3 inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-gray-800 to-blue-500 shadow-white hover:shadow-white rounded-full  border-none text-white font-semibold   shadow-md  transition"
            >
