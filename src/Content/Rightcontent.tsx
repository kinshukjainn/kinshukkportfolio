      ...
      {loading ? (
        ...
        <>
          <motion.h2
            ...
            className="text-4xl font-bold mb-3 text-transparent bg-gradient-to-r from-blue-500 via-red-500 via-yellow-500 to-green-400 bg-clip-text tracking-wide flex items-center gap-3"
          >
            Hey Folks!! 🚀
          </motion.h2>
