...
const RightContent = ({ className = "" }) => {
  return (
    <div className={`bg-black border border-gray-700 font-poppins shadow-lg p-4 md:p-6 rounded-2xl w-full lg:w-1/2 flex-shrink-0 max-w-3xl mx-auto lg:mx-0 ${className}`}>
      ...
      <h2 className="text-3xl font-bold mb-3 text-blue-500 flex items-center gap-3">
        Hey Folks!! 🚀
      </h2>
      <p className="text-gray-300 leading-relaxed text-base md:text-lg">
        My name is <span className="font-bold text-blue-500">Kinshuk Jain</span>. 
        I am passionate about <span className="text-blue-500 font-medium">Cloud Computing, Infrastructure as Code, and Cybersecurity.</span>  
        I specialize in designing scalable cloud architectures and secure infrastructures. 
        I believe cloud is not just about tools—it's about <span className="font-semibold text-blue-500">mindset, optimization, and automation</span>.
      </p>
      ...
      <h2 className="text-2xl font-semibold mb-3 text-blue-500 flex items-center gap-3">
        ...
        <MdOutlineKeyboardDoubleArrowRight className="text-blue-500 text-4xl" /> Education
      </h2>
      ...
      <h2 className="text-2xl font-semibold mb-3 text-blue-500 flex items-center gap-3">
        ...
        <MdOutlineKeyboardDoubleArrowRight className="text-blue-500 text-4xl" /> Certifications
      </h2>
      <ul className="space-y-3 text-gray-300 text-base md:text-lg">
        <li className="flex items-center gap-3">
